...
namespace Connected_Eg1
{
    class Program
    {
        ...
        {
            con = new SqlConnection(@"data source=ICS-LT-17YRQ73\SQLEXPRESS; initial catalog=InfiniteDB;" + "user id=sa; password=santu2001;");
            con.Open();
            return con;
        }
        ...
        public static void UpdateData()
        {
            ...
            // Update statement
            cmd = new SqlCommand("UPDATE tbldepartment SET deptname=@deptname, budget=@budget, loc=@loc WHERE deptno=@deptno", con);
